import {
  NoSsr_default
} from "./chunk-R6AKNVDI.js";
import {
  Popper_default
} from "./chunk-27SZFTI3.js";
import "./chunk-PHMPSSMQ.js";
import "./chunk-3QC4X2SW.js";
import "./chunk-3ZYPU7UK.js";
import "./chunk-FMFFUJ5P.js";
import {
  useTheme
} from "./chunk-MDDWJ736.js";
import {
  Typography_default
} from "./chunk-V4MY7VEH.js";
import {
  require_react_dom
} from "./chunk-WRD5HZVH.js";
import "./chunk-EEYR5LKQ.js";
import "./chunk-PCBCEYNY.js";
import {
  init_esm,
  init_ownerWindow,
  init_useControlled,
...
} from "./chunk-7NPJHMHP.js";
import "./chunk-MLT4CGBB.js";
import {
  useThemeProps
} from "./chunk-Z7W5HWPH.js";
import "./chunk-NGZYNJHZ.js";
import {
  init_useForkRef,
  useForkRef
} from "./chunk-S2DBJ6KD.js";
import "./chunk-ES5L7XYT.js";
import "./chunk-W24IQVB3.js";
import {
  styled_default
} from "./chunk-3E43P35P.js";
import "./chunk-HCCBAYMG.js";
import {
  ...
  require_prop_types,
  require_react_is
} from "./chunk-PUPRMOWO.js";
import {
  init_emotion_styled_browser_development_esm,
  styled
} from "./chunk-W7H2GU4Z.js";
import {
  CacheProvider,
  Global,
  StyleSheet,
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(React32.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style4) => (0, import_jsx_runtime8.jsx)(animated.rect, {
        // @ts-expect-error
        x: 0,
        y: 0,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const [width2, setWidth] = React50.useState(0);
  const [height2, setHeight] = React50.useState(0);
...
var RtlContext = React58.createContext();
function RtlProvider({
  value,
  ...props
}) {
  return (0, import_jsx_runtime27.jsx)(RtlContext.Provider, {
    value: value ?? true,
    ...props
  });
}
...
var useRtl = () => {
  const value = React58.useContext(RtlContext);
  return value ?? false;
};
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime28.jsxs)(YAxisRoot, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React60.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React61.useState(null);
  React61.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function StyledEngineProvider(props) {
  ...
  return cache ? (0, import_jsx_runtime30.jsx)(CacheProvider, {
    value: cache,
    children
  }) : children;
}
true ? StyledEngineProvider.propTypes = {
   ...
   */
  enableCssLayer: import_prop_types20.default.bool,
  /**
   * By default, the styles are injected last in the <head> element of the page.
   * As a result, they gain more specificity than any other style sheet.
   * If you want to override MUI's styles, set this prop.
   */
  injectFirst: import_prop_types20.default.bool
} : void 0;
...
function GlobalStyles(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(Global, {
    styles: globalStyles
  });
}
true ? GlobalStyles.propTypes = {
  defaultTheme: import_prop_types21.default.object,
  styles: import_prop_types21.default.oneOfType([import_prop_types21.default.array, import_prop_types21.default.string, import_prop_types21.default.object, import_prop_types21.default.func])
} : void 0;
...
function deepClone(source) {
  if (React63.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React63.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
var responsivePropType = true ? import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string, import_prop_types22.default.object, import_prop_types22.default.array]) : {};
...
function useTheme2(defaultTheme4 = null) {
  const contextTheme = React64.useContext(ThemeContext);
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime32.jsx)(GlobalStyles, {
    styles: globalStyles
  });
}
true ? GlobalStyles2.propTypes = {
   ...
   * @ignore
   */
  themeId: import_prop_types24.default.string
} : void 0;
...
function createBox(options = {}) {
  ...
  const Box2 = React65.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime33.jsx)(BoxRoot, {
      as: component,
      ref,
...
var useEnhancedEffect = typeof window !== "undefined" ? React66.useLayoutEffect : React66.useEffect;
var useEnhancedEffect_default2 = useEnhancedEffect;

// node_modules/@mui/system/esm/useMediaQuery/useMediaQuery.js
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React67.useState(() => {
    if (noSsr && matchMedia) {
...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React67.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React67.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React67.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
var ThemeContext2 = React68.createContext(null);
if (true) {
...
function useTheme4() {
  const theme = React69.useContext(ThemeContext_default);
  if (true) {
...
function ThemeProvider(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(ThemeContext_default.Provider, {
    value: theme,
    children
  });
}
true ? ThemeProvider.propTypes = {
   ...
   */
  theme: import_prop_types26.default.oneOfType([import_prop_types26.default.object, import_prop_types26.default.func]).isRequired
} : void 0;
if (true) {
...
var PropsContext = React71.createContext(void 0);
function DefaultPropsProvider({
  value,
  children
}) {
  return (0, import_jsx_runtime35.jsx)(PropsContext.Provider, {
    value,
    children
  });
}
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React72.useState(idOverride);
...
function useLayerOrder(theme) {
  ...
  return (0, import_jsx_runtime36.jsx)(GlobalStyles_default, {
    styles: layerOrder
  });
}
...
function ThemeProvider2(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime37.jsx)(ThemeContext.Provider, {
      value: engineTheme,
      children: (0, import_jsx_runtime37.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime37.jsxs)(DefaultPropsProvider_default, {
...
true ? ThemeProvider2.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types28.default.oneOfType([import_prop_types28.default.func, import_prop_types28.default.object]).isRequired,
  /**
...
function createContainer(options = {}) {
  ...
  const Container2 = React76.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime40.jsx)(ContainerRoot, {
        as: component,
        ownerState,
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React77.isValidElement(element) && muiNames.indexOf(
...
function createGrid(options = {}) {
  ...
  const Grid2 = React78.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime41.jsx)(GridRoot2, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ...
      children: React78.Children.map(children, (child) => {
        var _a;
        if (React78.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index2) => {
    ...
    if (index2 < childrenArray.length - 1) {
      output.push(React79.cloneElement(separator, {
...
function createStack(options = {}) {
  ...
  const Stack2 = React79.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
    ...
    return (0, import_jsx_runtime42.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className),
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime43.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime43.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime43.jsx)("tbody", {
        children: (0, import_jsx_runtime43.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime43.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime43.jsx)(ChartsTooltipMark, {
              color: color3,
              className: classes.mark
            })
          }), (0, import_jsx_runtime43.jsx)(ChartsTooltipCell, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types36.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types36.default.shape({
    dataIndex: import_prop_types36.default.number,
    seriesId: import_prop_types36.default.oneOfType([import_prop_types36.default.number, import_prop_types36.default.string]).isRequired,
    type: import_prop_types36.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types36.default.object.isRequired,
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React81.useContext(ZAxisContext);
  ...
  return (0, import_jsx_runtime44.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime45.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime45.jsx)("thead", {
        children: (0, import_jsx_runtime45.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime45.jsx)(ChartsTooltipCell, {
            colSpan: 3,
            children: (0, import_jsx_runtime45.jsx)(Typography_default, {
      ...
      }), (0, import_jsx_runtime45.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime45.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime45.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime45.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime45.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime45.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types37.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types37.default.shape({
    x: import_prop_types37.default.shape({
      index: import_prop_types37.default.number,
      value: import_prop_types37.default.oneOfType([import_prop_types37.default.instanceOf(Date), import_prop_types37.default.number, import_prop_types37.default.string]).isRequired
    }),
    y: import_prop_types37.default.shape({
      index: import_prop_types37.default.number,
      value: import_prop_types37.default.oneOfType([import_prop_types37.default.instanceOf(Date), import_prop_types37.default.number, import_prop_types37.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types37.default.oneOfType([import_prop_types37.default.instanceOf(Date), import_prop_types37.default.number, import_prop_types37.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React83.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React83.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React83.useMemo(() => {
  ...
  return (0, import_jsx_runtime46.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime47.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime47.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime47.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime47.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime48.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime48.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React88.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  ...
  return (0, import_jsx_runtime49.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime49.jsx)(ChartsLegendRoot, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types39.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types39.default.shape({
    bottom: import_prop_types39.default.number.isRequired,
    height: import_prop_types39.default.number.isRequired,
    left: import_prop_types39.default.number.isRequired,
    right: import_prop_types39.default.number.isRequired,
    top: import_prop_types39.default.number.isRequired,
    width: import_prop_types39.default.number.isRequired
  }).isRequired,
  /**
  ...
  series: import_prop_types39.default.object.isRequired,
  seriesToDisplay: import_prop_types39.default.arrayOf(import_prop_types39.default.shape({
    ...
    itemId: import_prop_types39.default.oneOfType([import_prop_types39.default.number, import_prop_types39.default.string]),
    label: import_prop_types39.default.string.isRequired,
    maxValue: import_prop_types39.default.oneOfType([import_prop_types39.default.instanceOf(Date), import_prop_types39.default.number]),
    minValue: import_prop_types39.default.oneOfType([import_prop_types39.default.instanceOf(Date), import_prop_types39.default.number]),
...
function ChartsLegend(inProps) {
  ...
  const theme = useTheme();
  const classes = useUtilityClasses8(_extends({}, defaultizedProps, {
    theme
  }));
  const drawingArea = useDrawingArea();
  const series = useSeries();
  ...
  return (0, import_jsx_runtime51.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime52.jsxs)(React92.Fragment, {
    children: [(0, import_jsx_runtime52.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime52.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime52.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types41.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types41.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
  axisId: import_prop_types41.default.oneOfType([import_prop_types41.default.number, import_prop_types41.default.string]),
  /**
   * The direction of the legend layout.
   * The default depends on the chart.
   */
   ...
   * @default '50%'
   */
  length: import_prop_types41.default.oneOfType([import_prop_types41.default.number, import_prop_types41.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types41.default.oneOfType([import_prop_types41.default.func, import_prop_types41.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types41.default.oneOfType([import_prop_types41.default.func, import_prop_types41.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types41.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types42.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
  axisId: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types42.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types42.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types42.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
  itemGap: import_prop_types42.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types42.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types42.default.number,
  /**
   * Format the legend labels.
   * @param {PiecewiseLabelFormatterParams} params The bound of the piece to format.
   * @returns {string|null} The displayed label, or `null` to skip the item.
   */
  labelFormatter: import_prop_types42.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
   ...
   * @default 5
   */
  markGap: import_prop_types42.default.number,
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<SVGRectElement, MouseEvent>} event The click event.
   ...
   * @default 10
   */
  padding: import_prop_types42.default.oneOfType([import_prop_types42.default.number, import_prop_types42.default.shape({
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime54.jsxs)(React94.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime54.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime54.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime54.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime54.jsx)(ChartsAxisHighlightPath, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime55.jsx)("clipPath", {
    id,
    children: (0, import_jsx_runtime55.jsx)("rect", {
      x: left2 - offset.left,
      y: top2 - offset.top,
...
true ? ChartsClipPath.propTypes = {
  ...
  offset: import_prop_types44.default.shape({
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime56.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
function LineHighlightPlot(props) {
  ...
  return (0, import_jsx_runtime57.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ids: groupIds
    }) => {
      return groupIds.flatMap((seriesId) => {
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime58.jsx)(React98.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime58.jsx)(GridLine, {
      y1: drawingArea.top,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(React99.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime59.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: drawingArea.left,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime60.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime60.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime60.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React101.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime61.jsx)(React101.Fragment, {});
}
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(StyledText, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime63.jsx)(StyledText2, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime64.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime64.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var LineChart = React105.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime65.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime65.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime65.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime65.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime65.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime65.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime65.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime65.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime65.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime65.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime65.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime65.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime65.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime65.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime65.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types49.default.oneOfType([import_prop_types49.default.object, import_prop_types49.default.string]),
   ...
   */
  disableLineItemHighlight: import_prop_types49.default.bool,
  /**
   * If `true` marks will render `<circle />` instead of `<path />` and drop theme override for faster rendering.
   */
  experimentalMarkRendering: import_prop_types49.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types49.default.shape({
    horizontal: import_prop_types49.default.bool,
    vertical: import_prop_types49.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types49.default.oneOfType([import_prop_types49.default.object, import_prop_types49.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types49.default.shape({
    classes: import_prop_types49.default.object,
    direction: import_prop_types49.default.oneOf(["column", "row"]),
   ...
   */
  onAreaClick: import_prop_types49.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   ...
   */
  onLineClick: import_prop_types49.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types49.default.func,
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
   ...
   * @default null
   */
  rightAxis: import_prop_types49.default.oneOfType([import_prop_types49.default.object, import_prop_types49.default.string]),
  /**
   * The series to display in the line chart.
   * An array of [[LineSeriesType]] objects.
   */
  series: import_prop_types49.default.arrayOf(import_prop_types49.default.object).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
   ...
   * @default null
   */
  topAxis: import_prop_types49.default.oneOfType([import_prop_types49.default.object, import_prop_types49.default.string]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types49.default.arrayOf(import_prop_types49.default.shape({
    classes: import_prop_types49.default.object,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types49.default.arrayOf(import_prop_types49.default.shape({
    classes: import_prop_types49.default.object,
    colorMap: import_prop_types49.default.oneOfType([import_prop_types49.default.shape({
      colors: import_prop_types49.default.arrayOf(import_prop_types49.default.string).isRequired,
      type: import_prop_types49.default.oneOf(["ordinal"]).isRequired,
