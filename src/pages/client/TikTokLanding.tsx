...
import { videoApi, FeedPreviewItem } from '@/api/video.service'
...
const TikTokLanding: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            >
                <Typography variant="h6" sx={{ fontSize: 17, fontWeight: '800', cursor: 'pointer', pointerEvents: 'auto', '&:hover': { color: 'white' } }}>
                    Following
                </Typography>
                <Typography variant="h6" sx={{ fontSize: 17, fontWeight: '800', color: 'white', borderBottom: '3px solid white', paddingBottom: '5px', cursor: 'pointer', pointerEvents: 'auto' }}>
                    For You
                </Typography>
            </Stack>
