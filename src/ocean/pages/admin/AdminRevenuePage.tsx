...
import type { AnalyticsOverview, RevenueData, TopVideo } from '@/ocean/types'
                  ...
                  <TableCell>
                    <Stack direction="row" spacing={1.5} alignItems="center">
                      <Avatar sx={{ width: 32, height: 32, fontSize: '0.75rem', fontWeight: 800, bgcolor: 'secondary.light', color: 'secondary.main', borderRadius: '10px' }}>
                        {v.creator.name?.charAt(0) || 'C'}
                      </Avatar>
                      <Typography variant="body2" fontWeight={700}>{v.creator.name || 'Creator'}</Typography>
                    </Stack>
                  </TableCell>
                  <TableCell align="right">
