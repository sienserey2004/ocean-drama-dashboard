...
import { Tag, Category as CategoryType } from '@/ocean/types'
...
export default function AdminCategoriesPage() {
  ...
  return (
    <Box>
      ...
      >
        <DialogTitle component="div" sx={{ fontWeight: 800 }}>{editCat ? 'Update Strategy' : 'New Strategic Theme'}</DialogTitle>
